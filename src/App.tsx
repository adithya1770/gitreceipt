...
function App() {
  ...
  return (
    <BackgroundLines className="flex items-center justify-center w-full flex-col px-4">
      ...
      <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@24,400,0,0&icon_names=memory" />
      ...
      <div className='z-10'>
        ...
        <button><span className="material-symbols-outlined text-amber-50 ml-10"><p className='text-5xl'>memory</p></span></button>
      </div>
    </BackgroundLines>
  )
}
